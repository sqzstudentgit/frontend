        ...
        >
          <Row justify="space-around" align="middle">
            ...
            <Col>
              ...
              <Button size="small" type="secondary" icon={<MinusOutlined />} onClick={() => handleIncrement(-1)} />
              <InputNumber size="small" min={1} max={100} defaultValue={1} value={quantity} onChange={(value) => handleChange(value)} />
              <Button size="small" type="secondary" icon={<PlusOutlined />} onClick={() => handleIncrement(1)} />
            </Col>
            <Col>
